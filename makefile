...
override DEFAULT_KCFLAGS := -pipe -Wall -Wextra
...
obj/interrupts/idt.c.o: src/interrupts/idt.c
	mkdir -p "$$(dirname $@)"
	$(KCC) $(KCFLAGS) $(KCPPFLAGS) -mno-sse -mno-red-zone -ffreestanding -mno-80387 -c $< -o $@
